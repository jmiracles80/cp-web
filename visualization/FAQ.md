...
```sh
$ npm install sails-generate-visualization
```

[![NPM](https://nodei.co/npm/sails-generate-visualization.png?downloads=true&stars=true)](https://nodei.co/npm/sails-generate-visualization/)
...
[![githalytics.com alpha](https://cruel-carlota.pagodabox.com/8acf2fc2ca0aca8a3018e355ad776ed7 "githalytics.com")](http://githalytics.com/balderdashy/sails-generate-visualization/FAQ.md)
